...
export default function FeePayment() {
  ...
  const filterPayment = payments.filter((payment) => {
    return payment?.name.toLowerCase().includes(search?.toLowerCase()) || payment?.fullName.toLowerCase().includes(search?.toLowerCase()) || payment.department.toLowerCase().includes(search.toLowerCase()) || payment.faculty?.toLowerCase().includes(search.toLowerCase()) || payment.amount?.toString().toLowerCase().includes(search.toLowerCase()) || payment.level?.toLowerCase().includes(search.toLowerCase()) || payment.session?.toLowerCase().includes(search.toLowerCase()) || payment.semester?.toLowerCase().includes(search.toLowerCase()) || payment.level?.toLowerCase().includes(search.toLowerCase()) || payment.receipt_number?.toLowerCase().includes(search.toLowerCase()) || payment.confirmation_number?.toLowerCase().includes(search.toLowerCase()) || payment.invoice_no?.toLowerCase().includes(search.toLowerCase()) || payment.date?.toLowerCase().includes(search.toLowerCase())
  })
